...
plot(R.D.Spend, Profit)   # Profit With Respect to R.D.Spend

plot(Administration, Profit)   # Profit With Respect to Administration

plot(Marketing.Spend, Profit)   # Profit With Respect to Marketing Spend

plot(State, Profit)   # Profit With Respect to State
...
# Applying Normalization technique to the whole dataset :
