##Support Vector Machine _ Salary
...
View(train_sal)   #To view the train data
...
View(test_sal)   #To view the test data
...
plot(train_sal$workclass,train_sal$Salary)   #Graph with Work class

plot(train_sal$education,train_sal$Salary)   #Graph with Education

plot(train_sal$educationno,train_sal$Salary)   #Graph with Education number

plot(train_sal$maritalstatus,train_sal$Salary)   #Graph with Marital status

plot(train_sal$occupation,train_sal$Salary)   #Graph with Occupation

plot(train_sal$relationship,train_sal$Salary)   #Graph with Relationship

plot(train_sal$sex,train_sal$Salary)   #Graph with Gender
...
plot(train_sal$native,train_sal$Salary)   #Graph with native
